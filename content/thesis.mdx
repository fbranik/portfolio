...
learning models were compiled in python using various libraries like pandas, numpy and tensorflow. You can view a web-based presentation of this thesis [here](https://presentation.fbranikas.com/). The full thesis, along with the final datasets and some of the developed tools can be found on this [GitHub repo](https://github.com/fbranik/FBThesis). 
